...
function calcularSoma(call, callback) {
...
server.addService(calculadora_proto.Calculadora.service, { Calcular: calcularSoma });
server.bindAsync('127.0.0.1:50051', grpc.ServerCredentials.createInsecure(), () => {
  console.log('Servidor de Soma rodando em 127.0.0.1:50051');
  server.start();
});